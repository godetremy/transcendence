...
CREATE TABLE "permission" (
    ...
    "create_event" BOOLEAN NOT NULL DEFAULT false,
    "modify_event" BOOLEAN NOT NULL DEFAULT false,
    "delete_event" BOOLEAN NOT NULL DEFAULT false,
    "modify_event_other" BOOLEAN NOT NULL DEFAULT false,
    "delete_event_other" BOOLEAN NOT NULL DEFAULT false,
    "create_service" BOOLEAN NOT NULL DEFAULT false,
    "modify_service" BOOLEAN NOT NULL DEFAULT false,
    "delete_service" BOOLEAN NOT NULL DEFAULT false,
    "modify_service_other" BOOLEAN NOT NULL DEFAULT false,
    "delete_service_other" BOOLEAN NOT NULL DEFAULT false,
