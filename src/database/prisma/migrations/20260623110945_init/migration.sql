...
-- AddForeignKey
ALTER TABLE "events" ADD CONSTRAINT "events_photos_album_id_fkey" FOREIGN KEY ("photos_album_id") REFERENCES "photos_album"("id") ON DELETE SET NULL ON UPDATE CASCADE;
...
-- AddForeignKey
ALTER TABLE "organization_followers" ADD CONSTRAINT "organization_followers_organization_id_fkey" FOREIGN KEY ("organization_id") REFERENCES "organizations"("id") ON DELETE RESTRICT ON UPDATE CASCADE;
...
-- AddForeignKey
ALTER TABLE "organization_permission" ADD CONSTRAINT "organization_permission_organization_id_fkey" FOREIGN KEY ("organization_id") REFERENCES "organizations"("id") ON DELETE SET NULL ON UPDATE CASCADE;

-- AddForeignKey
ALTER TABLE "photos" ADD CONSTRAINT "photos_album_id_fkey" FOREIGN KEY ("album_id") REFERENCES "photos_album"("id") ON DELETE RESTRICT ON UPDATE CASCADE;
...
-- AddForeignKey
ALTER TABLE "photos_album_reports" ADD CONSTRAINT "photos_album_reports_album_id_fkey" FOREIGN KEY ("album_id") REFERENCES "photos_album"("id") ON DELETE RESTRICT ON UPDATE CASCADE;
...
-- AddForeignKey
ALTER TABLE "services" ADD CONSTRAINT "services_photo_album_id_fkey" FOREIGN KEY ("photo_album_id") REFERENCES "photos_album"("id") ON DELETE SET NULL ON UPDATE CASCADE;
