...
const logoutUser = (headers: HeadersInit | undefined): UseMutationOptions<{ success: boolean }, Error, void, void> => ({
	mutationFn: () => post<{ success: boolean }>(`/auth/logout`, {}, true, headers),
	onSuccess: () => {
